...
class Evenement
{
     ...
     * @param string $etat
     */
    public function __construct(int $id, int $idOrganisateur, string $type, string $titre, string $description, string $lieu, \DateTime $dateEvent, string $image, float $tarif, int $capacite, int $nbReservation, string $etat)
    {
        $this->id = $id;
