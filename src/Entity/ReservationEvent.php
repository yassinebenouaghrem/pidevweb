...
class ReservationEvent
{
    ...
    public function __toString()
    {
        ...
        return "Nom du client: ".$this->getIdClient()."\nTitre de l'événement: ".$this->getTitreEvent()
            ."\nDate de l'événement: ".$result."\nNombre de place réservé: ".$this->getNbPlace().
            "\nMontant: ".$this->getTotal()."dt\nMode de paiement: ".$this->getModePaiement();
    }
